...
\begin{table}[htpb]
	...
	\begin{tabular}{lccc}
		...
		avg voltage [vm p.u.] & 1.012 & 1.025 & 1.041 \\
		bracket deviation [\%] & 37.8 & 25.3 & 9.2 \\
		\bottomrule
	\end{tabular}
	\caption{Energy community charging times for test feeder network.}
...
\begin{equation}
	\text{Deviation} = \frac{\text{Upper bracket} - \text{Average voltage}}{\text{Upper bracket}-\text{Lower bracket}}times 100
\end{equation}
...
\subsection{Code}
splitting function could waste less data\\
energy comm func could start the cycle at peak time\\
